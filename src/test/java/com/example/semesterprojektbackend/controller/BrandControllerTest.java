...
class BrandControllerTest {
    ...
    @Test
    void testDeleteBrand2() throws Exception {
    ...
    @Test
    void testDeleteBrand3() throws Exception {
        doNothing().when(this.brandService).delete(anyInt());
        MockHttpServletRequestBuilder deleteResult = MockMvcRequestBuilders.delete("/brands/{brandId}", 123);
    ...
    @Test
    void testGetBrand2() throws Exception {
        when(this.brandService.getBrands()).thenReturn(new ArrayList<>());
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/brands");
        MockMvcBuilders.standaloneSetup(this.brandController)
                .build()
    ...
    @Test
    void testGetBrand3() throws Exception {
        when(this.brandService.getBrands()).thenReturn(new ArrayList<>());
        MockHttpServletRequestBuilder getResult = MockMvcRequestBuilders.get("/brands");
